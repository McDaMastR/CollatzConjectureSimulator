...
#define CZ_POSIX_ADVISORY_INFO ( _POSIX_ADVISORY_INFO + 0 )
#else
...
#define CZ_POSIX_ASYNCHRONOUS_IO ( _POSIX_ASYNCHRONOUS_IO + 0 )
#else
...
#define CZ_POSIX_BARRIERS ( _POSIX_BARRIERS + 0 )
#else
...
#define CZ_POSIX_CLOCK_SELECTION ( _POSIX_CLOCK_SELECTION + 0 )
#else
...
#define CZ_POSIX_CPUTIME ( _POSIX_CPUTIME + 0 )
#else
...
#define CZ_POSIX_FSYNC ( _POSIX_FSYNC + 0 )
#else
...
#define CZ_POSIX_IPV6 ( _POSIX_IPV6 + 0 )
#else
...
#define CZ_POSIX_JOB_CONTROL ( _POSIX_JOB_CONTROL + 0 )
#else
...
#define CZ_POSIX_MAPPED_FILES ( _POSIX_MAPPED_FILES + 0 )
#else
...
#define CZ_POSIX_MEMLOCK ( _POSIX_MEMLOCK + 0 )
#else
...
#define CZ_POSIX_MEMLOCK_RANGE ( _POSIX_MEMLOCK_RANGE + 0 )
#else
...
#define CZ_POSIX_MEMORY_PROTECTION ( _POSIX_MEMORY_PROTECTION + 0 )
#else
...
#define CZ_POSIX_MESSAGE_PASSING ( _POSIX_MESSAGE_PASSING + 0 )
#else
...
#define CZ_POSIX_MONOTONIC_CLOCK ( _POSIX_MONOTONIC_CLOCK + 0 )
#else
...
#define CZ_POSIX_NO_TRUNC ( _POSIX_NO_TRUNC + 0 )
#else
...
#define CZ_POSIX_PRIORITIZED_IO ( _POSIX_PRIORITIZED_IO + 0 )
#else
...
#define CZ_POSIX_PRIORITY_SCHEDULING ( _POSIX_PRIORITY_SCHEDULING + 0 )
#else
...
#define CZ_POSIX_RAW_SOCKETS ( _POSIX_RAW_SOCKETS + 0 )
#else
...
#define CZ_POSIX_READER_WRITER_LOCKS ( _POSIX_READER_WRITER_LOCKS + 0 )
#else
...
#define CZ_POSIX_REALTIME_SIGNALS ( _POSIX_REALTIME_SIGNALS + 0 )
#else
...
#define CZ_POSIX_REGEXP ( _POSIX_REGEXP + 0 )
#else
...
#define CZ_POSIX_SAVED_IDS ( _POSIX_SAVED_IDS + 0 )
#else
...
#define CZ_POSIX_SEMAPHORES ( _POSIX_SEMAPHORES + 0 )
#else
...
#define CZ_POSIX_SHARED_MEMORY_OBJECTS ( _POSIX_SHARED_MEMORY_OBJECTS + 0 )
#else
...
#define CZ_POSIX_SHELL ( _POSIX_SHELL + 0 )
#else
...
#define CZ_POSIX_SPAWN ( _POSIX_SPAWN + 0 )
#else
...
#define CZ_POSIX_SPIN_LOCKS ( _POSIX_SPIN_LOCKS + 0 )
#else
...
#define CZ_POSIX_SPORADIC_SERVER ( _POSIX_SPORADIC_SERVER + 0 )
#else
...
#define CZ_POSIX_SYNCHRONIZED_IO ( _POSIX_SYNCHRONIZED_IO + 0 )
#else
...
#define CZ_POSIX_THREAD_ATTR_STACKADDR ( _POSIX_THREAD_ATTR_STACKADDR + 0 )
#else
...
#define CZ_POSIX_THREAD_ATTR_STACKSIZE ( _POSIX_THREAD_ATTR_STACKSIZE + 0 )
#else
...
#define CZ_POSIX_THREAD_CPUTIME ( _POSIX_THREAD_CPUTIME + 0 )
#else
...
#define CZ_POSIX_THREAD_PRIO_INHERIT ( _POSIX_THREAD_PRIO_INHERIT + 0 )
#else
...
#define CZ_POSIX_THREAD_PRIO_PROTECT ( _POSIX_THREAD_PRIO_PROTECT + 0 )
#else
...
#define CZ_POSIX_THREAD_PRIORITY_SCHEDULING ( _POSIX_THREAD_PRIORITY_SCHEDULING + 0 )
#else
...
#define CZ_POSIX_THREAD_PROCESS_SHARED ( _POSIX_THREAD_PROCESS_SHARED + 0 )
#else
...
#define CZ_POSIX_THREAD_SAFE_FUNCTIONS ( _POSIX_THREAD_SAFE_FUNCTIONS + 0 )
#else
...
#define CZ_POSIX_THREAD_SPORADIC_SERVER ( _POSIX_THREAD_SPORADIC_SERVER + 0 )
#else
...
#define CZ_POSIX_THREADS ( _POSIX_THREADS + 0 )
#else
...
#define CZ_POSIX_TIMEOUTS ( _POSIX_TIMEOUTS + 0 )
#else
...
#define CZ_POSIX_TIMERS ( _POSIX_TIMERS + 0 )
#else
...
#define CZ_POSIX_TRACE ( _POSIX_TRACE + 0 )
#else
...
#define CZ_POSIX_TRACE_EVENT_FILTER ( _POSIX_TRACE_EVENT_FILTER + 0 )
#else
...
#define CZ_POSIX_TRACE_INHERIT ( _POSIX_TRACE_INHERIT + 0 )
#else
...
#define CZ_POSIX_TRACE_LOG ( _POSIX_TRACE_LOG + 0 )
#else
...
#define CZ_POSIX_TYPED_MEMORY_OBJECTS ( _POSIX_TYPED_MEMORY_OBJECTS + 0 )
#else
...
#define CZ_XOPEN_CRYPT ( _XOPEN_CRYPT + 0 )
#else
...
#define CZ_XOPEN_LEGACY ( _XOPEN_LEGACY + 0 )
#else
...
#define CZ_XOPEN_REALTIME ( _XOPEN_REALTIME + 0 )
#else
...
#define CZ_XOPEN_REALTIME_THREADS ( _XOPEN_REALTIME_THREADS + 0 )
#else
...
#define CZ_XOPEN_STREAMS ( _XOPEN_STREAMS + 0 )
#else
...
#define CZ_FILE_OFFSET_BITS ( _FILE_OFFSET_BITS + 0 )
...
#define CZ_POSIX_C_SOURCE ( _POSIX_C_SOURCE + 0 )
...
#define CZ_TIME_BITS ( _TIME_BITS + 0 )
#else
...
#define CZ_XOPEN_SOURCE ( _XOPEN_SOURCE + 0 )
