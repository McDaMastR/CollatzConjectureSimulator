...
bool get_buffer_requirements_noext(VkDevice device, VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryRequirements* memoryRequirements) NONNULL_ARGS_ALL WR_ACCESS(4);
bool get_buffer_requirements_main4(VkDevice device, VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryRequirements* memoryRequirements) NONNULL_ARGS_ALL WR_ACCESS(4);
