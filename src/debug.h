...
#define FOPEN_FAILURE(res, name, mode)     print_fopen_failure(__LINE__, (FILE*) (res), (const char*) (name), (const char*) (mode))
#define FSEEK_FAILURE(res, file, off, ori) print_fseek_failure(__LINE__, (int)   (res), (FILE*) (file), (long) (off), (int) (ori))
